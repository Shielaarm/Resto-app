			...
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form method="POST" action="{{ route('login') }}" class="login100-form validate-form flex-sb flex-w">
                    ...
                    <div class="wrap-input100 validate-input m-b-36">
                        <x-label for="email" class="focus-input100" :value="__('Email')" />

                        <x-input id="email" class="block mt-1 w-full input100" type="email" name="email" :value="old('email')" required autofocus />
                    </div>
					...
					<div class="container-login100-form-btn">
                        <x-button class="ml-3 login100-form-btn">
                            {{ __('Log in') }}
                        </x-button>
					</div>
